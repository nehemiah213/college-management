...
from .serializers import ResultSerializer,CounsellorSerializer,StudentSerializer
...
class Counselling(View):
    def get(self, request):
        try:
            ...
            return JsonResponse({'students': serializer.data,'name':counsellor_name.name})
...
#@csrf_exempt
class CounsellorLoginAPIView(APIView):
